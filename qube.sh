...
dotnet sonarscanner begin /k:"project-key" /d:sonar.host.url="https://sonarqube-pnqi3qjntuz2a.azurewebsites.net": /d:sonar.login="$AZUREQUBETOKEN" /d:sonar.cs.opencover.reportsPaths="/home/vsts/work/1/s/CicdAppTests/CicdAppTests/TestResults/coverage.opencover.xml" /d:sonar.cs.vstest.reportsPaths="/home/vsts/work/1/s/CicdAppTests/CicdAppTests/TestResults/results.trx"
